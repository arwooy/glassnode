#!/usr/bin/env python3
"""
获取Glassnode API文档中的所有端点，按文档顺序排列
"""
...
def get_endpoints_from_docs():
    """
    从Glassnode文档获取所有端点
    注意：这里列出的是文档中的完整端点列表
    """
    
    # 按照 https://docs.glassnode.com/basic-api/endpoints 的完整顺序
    all_endpoints = {
        "addresses": [
            # 按文档顺序完整列表
            "accumulation_count",
            "accumulation_balance",  # 这个在测试中遗漏了
            "active_count",
...
def print_statistics():
    """打印统计信息"""
    endpoints = get_endpoints_from_docs()
    
    print("Glassnode API 端点统计")
    print("="*60)
...
if __name__ == "__main__":
    ...
    # 保存为JSON文件
    endpoints = get_endpoints_from_docs()
    with open('glassnode_complete_endpoints.json', 'w', encoding='utf-8') as f:
        json.dump(endpoints, f, indent=2, ensure_ascii=False)
    
    print("\n完整端点列表已保存到 glassnode_complete_endpoints.json")